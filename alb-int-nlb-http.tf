...
#
# RU: https://yandex.cloud/ru/docs/tutorials/security/migration-from-nlb-to-alb/nlb-as-target-resource-alb/terraform
# EN: https://yandex.cloud/en/docs/tutorials/security/migration-from-nlb-to-alb/nlb-as-target-resource-alb/terraform
...
locals {
  ...
  ip_address_int_nlb = "" # IP address of the internal Network Load Balancer
...
resource "yandex_alb_target_group" "alb-target-group" {
  ...
  target {
    ip_address           = local.ip_address_int_nlb
